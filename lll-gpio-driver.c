...
{
	unsigned int *gpio_off_registers = (unsigned int *)((char *)gpio_registers + 0x28);
	*gpio_off_registers |= (1<<pin);
	return;
}
...
static int __init gpio_driver_init(void){
	...
	// ask kernel to map address in and ask for full page of memory
	...
	// 0666 is permission, anyone can use
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Travis Russell");
MODULE_DESCRIPTION("Test of custom drivers");
MODULE_VERSION("1.0");
